        ...
        <div class="main clearfix">
            ...
            <div class="list">
                <div class="list-nav">
                    ...
                    <a class="cur" href="<?php echo site_url('manage/ad/add'); ?>">Add</a>
                </div>

                <div class="add">
                    <form action="<?php echo site_url('manage/ad/do_add'); ?>" method="post" enctype="multipart/form-data">
                        <table cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="add-rt"><input type="file" name="picfile" /></td>
                                </tr>
                                <tr>
