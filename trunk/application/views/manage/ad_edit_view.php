...
<body>
    <div class="wrap">
        ...
        <div class="main clearfix">
            ...
            <div class="list">
                <div class="list-nav">
                    <a href="<?php echo site_url('manage/ad/index'); ?>">List</a>
                    <a href="<?php echo site_url('manage/ad/add'); ?>">Add</a>
                </div>

                <div class="add">
                    <form action="<?php echo site_url('manage/ad/do_edit'); ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>"/>
                        <input type="hidden" name="old_pic_addr" value="<?php echo $pic_addr; ?>" />
                        <table cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    <td class="add-lt">Pic:</td>
                                    <td class="add-rt">
                                        <p><img src="<?php echo base_url().'assets/images/ad/'.$pic_addr; ?>" width="300" /></p>
