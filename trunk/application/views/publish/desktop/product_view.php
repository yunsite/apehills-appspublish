        ...
        <div id="footer" class="footer">
            <table cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td>
                            <a href="http://www.facebook.com/ApeHills" target="_blank"><img src="<?php echo base_url().'images/publish/' ?>facebook_icon.png" /></a>
                        </td>
                        <td>
                            <a href="http://twitter.com/#!/ApeHills" target="_blank"><img src="<?php echo base_url().'images/publish/' ?>twitter_icon.png" /></a>
                        </td>
                        <td>
                            <a href="http://apehills.com" target="_blank"><img src="<?php echo base_url().'images/publish/' ?>ah_icon.png" /></a>
                        </td>
                    </tr>
                </tbody>
            </table>
